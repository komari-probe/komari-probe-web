...
const Node = React.memo(
  ...
  return (
    <Card
      ...
      onClick={() => navigate(`/instance/${basic.uuid}`)}
    >
...
import PriceTags from "@/shared/components/PriceTags";
import { TrendingUp } from "lucide-react";
import MiniPingChartFloat from "@/default-theme/components/MiniPingChartFloat";
import { getOSImage, getOSName } from "@/shared/utils/osImageHelper";
