...
import { Apache2_LICENSE, MIT_LICENSE } from "@/admin-ui/utils/field";
import { getEula } from "@/admin-ui/utils/eula";
import { SettingCardCollapse } from "@/admin-ui/components/SettingCard";
...
export default function AboutPage() {
  ...
  useEffect(() => {
    fetch(
      "https://raw.githubusercontent.com/komari-probe/komari-probe/refs/heads/main/README.md"
    )
      .then((res) => res.text())
      .then(setMarkdown);
  }, []);
          ...
          case "readme":
            return (
              <>
                ...
                <a
                  href="https://github.com/komari-probe/komari-probe/blob/main/README.md"
                  target="_blank"
                  rel="noreferrer"
